...
public class C11EX04a {
    public static void main(String[] args) {
        ...
        //Calcular dados sobre multas de trânsito com repetição definida
        ...
        int rep = Integer.parseInt(JOptionPane.showInputDialog(null,"Informe a quantidade de multas que serão lidas:","Pergunta",JOptionPane.QUESTION_MESSAGE));
